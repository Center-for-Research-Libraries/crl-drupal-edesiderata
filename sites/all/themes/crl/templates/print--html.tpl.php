...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language; ?>" version="XHTML+RDFa 1.0" dir="<?php print $language->dir; ?>">
  <head>
    ...
    <?php 
      // Bypass script printing to avoid rendering field groups as tabs
      // print $scripts; 
    ?>
  ...
  <body>
    ...
    <?php
    // We add our own "send to printer" handling as we have stripped all
    // header scripts from the page. Given the absense of script data this
    // should be safe to do inline.
    if (!empty($sendtoprinter)): ?>
