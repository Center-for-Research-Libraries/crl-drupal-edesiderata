(function($) {
  $(document).ready(function(){
    ...
    if (window.location.host == ref_split[2]) {
      ...
      // we can use a js browser back option for the back link INSTEAD of the
      // URL specified in the back link that's on the page already. This is tied
      ...
      if (ref_split[3] == "" ||
        ...
        (ref_split[3] == "providers" && ref_split[4].substring(0, 4) == "main") ||
        ref_split[3] == "me") {
